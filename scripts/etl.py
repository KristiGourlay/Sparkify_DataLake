...
def process_song_data(spark, input_data, output_data):
    ...
    """Processes the song data and creates a songs table and an artist table"""
...
def process_log_data(spark, input_data, output_data):
    ...
    """Processes the log data and creates a user table, a times table, and the songplays table"""
